...
class TickersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create ticker' do
    assert_difference('Ticker.count') do
      post tickers_url,
           params: { ticker: { ask_price: @ticker.ask_price, base_currency: @ticker.base_currency, bid_price: @ticker.bid_price,
                               exchanges_id: @ticker.exchanges_id, last_24h_volume: @ticker.last_24h_volume, last_price: @ticker.last_price, quote_currency: @ticker.quote_currency } }
    end
