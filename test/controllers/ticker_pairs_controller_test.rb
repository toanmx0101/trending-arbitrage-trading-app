...
class TickerPairsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ticker_pair" do
    assert_difference("TickerPair.count") do
      post ticker_pairs_url, params: { ticker_pair: { currency_id: @ticker_pair.currency_id, first_ticker_id: @ticker_pair.first_ticker_id, scheduler: @ticker_pair.scheduler, second_ticker_id: @ticker_pair.second_ticker_id, tele_channel_id: @ticker_pair.tele_channel_id, user_id: @ticker_pair.user_id } }
    end
  ...
  test "should update ticker_pair" do
    patch ticker_pair_url(@ticker_pair), params: { ticker_pair: { currency_id: @ticker_pair.currency_id, first_ticker_id: @ticker_pair.first_ticker_id, scheduler: @ticker_pair.scheduler, second_ticker_id: @ticker_pair.second_ticker_id, tele_channel_id: @ticker_pair.tele_channel_id, user_id: @ticker_pair.user_id } }
